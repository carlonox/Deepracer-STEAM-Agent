...
| Servicio | Detalle |
|----------|---------|
| **IP LAN** | Cambia con DHCP (2026-07: `10.203.191.86`). Verificar con `hostname -I` en el robot; `.env` debe tener la IP vigente o usar la Tailscale. |
...
| Handoff actual | `/workspace/docs/operations/HANDOFF.md` |
...
| Archivo | Propósito |
|---------|-----------|
| `/workspace/docs/operations/HANDOFF.md` | Este documento |
