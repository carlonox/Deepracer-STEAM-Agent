# Migración Hermes v0.16 → v0.18

> **RUTAS ANTIGUAS:** este documento es una bitácora histórica. Las rutas que
> menciona (`backend/`, `frontend/`, `RAG/`, `backup/`, `controlcamara.py` en la
> raíz, etc.) describen el estado del repositorio en el momento de la migración
> y **no son válidas hoy**. Para la estructura vigente consulta
> `../../README.md` y `../../ORGANIZACION_PROYECTO.md`.
