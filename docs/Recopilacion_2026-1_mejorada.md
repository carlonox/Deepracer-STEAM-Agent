...
La implementación actual se concentra en `controlcamara.py`. El controlador se comunica primero mediante un canal TCP local y utiliza la API HTTP del backend como mecanismo alternativo.
