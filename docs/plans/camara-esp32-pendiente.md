...
- [controlcamara.py](../../apps/navigation/src/controlcamara.py) ahora tiene `CAMERA_SOURCE = "esp32_udp"`.
- Python abre UDP `0.0.0.0:5000` y cada 0.5 s envia el texto
  `DEEPRACER_DISCOVER 5000` a `192.168.4.1:5001`.
- El firmware esta en [firmware/esp32-camera-udp](../../firmware/esp32-camera-udp):
...
- La documentacion de protocolo se actualizo en
  [protocolo-camara-esp32-udp.md](../architecture/protocolo-camara-esp32-udp.md).
...
1. Con la ESP conectada en `COM8`, reanudar la compilacion:
   ...
   Ejecutar dentro de `C:\Users\UNAL\Deepracer-STEAM-Agent\firmware\esp32-camera-udp`.
