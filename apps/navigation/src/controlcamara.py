...
# THROTTLE NORMALIZADO (calibración 2026-07-31): estos valores son [0..1]
# normalizados; el backend (vehicleControl.calibrateThrottle, THROTTLE_DEAD_ZONE=0.5)
# los estira al rango real [0.5, 1] del robot. 0 = parada.
# Reales resultantes: fast=0.70, min=0.60, reverse=0.60.
FORWARD_THROTTLE_SIGN = 1.0  # verificar convención por boot (negativo=adelante en 2026-07)
ARUCO_FAST_THROTTLE = 0.40
ARUCO_MIN_THROTTLE = 0.20
ARUCO_REVERSE_THROTTLE = 0.20
